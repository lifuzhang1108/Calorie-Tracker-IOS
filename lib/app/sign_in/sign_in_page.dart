...
import 'package:starter_architecture_flutter_firebase/services/auth.dart';
import 'package:starter_architecture_flutter_firebase/common_widgets/google_sign_in_button.dart';
...
class SignInPageContents extends StatelessWidget {
  const SignInPageContents(
      {Key? key, required this.viewModel, this.title = 'Calorie Tracker'})
      : super(key: key);
